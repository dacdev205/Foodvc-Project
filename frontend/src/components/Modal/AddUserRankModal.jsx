...
const AddUserRankModal = ({ open, onClose, onAddUserRank }) => {
  ...
  return (
    ...
    >
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full relative">
        ...
        <h2 className="text-2xl font-semibold mb-4">Thêm cấp bậc người dùng</h2>
        <input
          type="text"
...
export default AddUserRankModal;
