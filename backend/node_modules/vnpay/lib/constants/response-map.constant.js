...
exports.TRANSACTION_STATUS_RESPONSE_MAP =
	exports.REFUND_RESPONSE_MAP =
	exports.QUERY_DR_RESPONSE_MAP =
	exports.RESPONSE_MAP =
	exports.WRONG_CHECKSUM_KEY =
		void 0;
exports.WRONG_CHECKSUM_KEY = "WRONG_CHECKSUM_KEY";
exports.RESPONSE_MAP = new Map([
	...
	[exports.WRONG_CHECKSUM_KEY, { vn: "Sai checksum", en: "Wrong checksum" }],
	["default", { vn: "Giao dịch thất bại", en: "Failure" }],
]);
exports.QUERY_DR_RESPONSE_MAP = new Map([
...
exports.REFUND_RESPONSE_MAP = new Map([
	["00", { vn: "Yêu cầu thành công", en: "Success" }],
	[
		"02",
		{
...
exports.TRANSACTION_STATUS_RESPONSE_MAP = new Map([
	[
		"00",
		{
			vn: "Giao dịch thanh toán thành công",
