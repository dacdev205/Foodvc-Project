...
exports.VerifyReturnUrlSchema = exports.ReturnQueryFromVNPaySchema = exports.BuildPaymentUrlSchema = exports.commonSchema = exports.ConfigVnpaySchema = void 0;
const zod_1 = require("zod");
const enums_1 = require("../enums");
exports.ConfigVnpaySchema = zod_1.z.object({
    /**
     * Mã tmn của đối tác
     * @en Merchant tmn code
     */
    tmnCode: zod_1.z.string().min(1),
    /**
     * Mật khẩu bảo mật của đối tác
     * @en Secure secret of merchant
     */
    secureSecret: zod_1.z.string().min(1),
    /**
     * Đường dẫn trả về của đối tác
     * @en Return url of merchant
     */
    returnUrl: zod_1.z.string().url().min(1).optional(),
    /**
     * Phiên bản của API VNPay
     * @en Version of VNPay API
     */
    vnp_Version: zod_1.z.string().min(1).max(8).optional(),
    /**
     * Đơn vị tiền tệ
     * @en Currency code
     */
    vnp_CurrCode: zod_1.z.nativeEnum(enums_1.VnpCurrCode).optional(),
    /**
     * Ngôn ngữ hiển thị trên cổng thanh toán
     * @en Language display on payment gateway
     */
    vnp_Locale: zod_1.z.nativeEnum(enums_1.VnpLocale).optional(),
    /**
     ...
     */
    vnp_OrderType: zod_1.z.union([zod_1.z.nativeEnum(enums_1.VnpOrderType), zod_1.z.string()]).optional(),
    /**
     ...
     */
    api_Host: zod_1.z.string().url().min(1).optional(),
});
exports.commonSchema = zod_1.z.object({
     ...
     */
    vnp_Amount: zod_1.z.number().min(1).max(Number.MAX_SAFE_INTEGER),
    /**
     ...
     */
    vnp_OrderInfo: zod_1.z.string().min(1).max(255),
    /**
     ...
     * @example 123456
     */
    vnp_TxnRef: zod_1.z.string().min(1).max(100),
    /**
     * Mã website của merchant trên hệ thống của VNPAY
     * @en Website code of merchant on VNPAY system
     * @example 2QXUI4J4
     */
    vnp_TmnCode: zod_1.z.string().min(1).max(8).optional(),
    /**
     * Mã Ngân hàng thanh toán
     * @en Bank code
     * @example NCB
     */
    vnp_BankCode: zod_1.z.string().min(1).max(20).optional(),
});
exports.BuildPaymentUrlSchema = exports.commonSchema.extend({
    /**
     * Phiên bản của API VNPay
     * @en Version of VNPay API
     */
     ...
     */
    vnp_Command: zod_1.z.string().min(1).max(16).optional(),
    /**
     ...
     */
    vnp_CreateDate: zod_1.z.number().min(1).max(Number.MAX_SAFE_INTEGER).optional(),
    /**
     ...
     */
    vnp_IpAddr: zod_1.z.string().min(1).max(45).optional(),
    /**
     ...
     */
    vnp_ReturnUrl: zod_1.z.string().url().max(255).optional(),
    /**
...
exports.ReturnQueryFromVNPaySchema = exports.commonSchema.extend({
     ...
     */
    vnp_ResponseCode: zod_1.z.union([zod_1.z.string(), zod_1.z.number()]).optional(),
    /**
     ...
     * @see https://sandbox.vnpayment.vn/apis/docs/bang-ma-loi/
     */
    vnp_TransactionStatus: zod_1.z.union([zod_1.z.string(), zod_1.z.number()]).optional(),
    /**
     ...
     * @example HMACSHA512
     */
    vnp_SecureHashType: zod_1.z.string().optional(),
    /**
     ...
     *
     */
    vnp_SecureHash: zod_1.z.string().min(1).optional(),
});
exports.VerifyReturnUrlSchema = exports.ReturnQueryFromVNPaySchema.extend({
    /**
     * Trạng thái giao dịch
     * @en Transaction status
     * @example true
     */
    isSuccess: zod_1.z.boolean().default(false),
    /**
     * Thông báo lỗi
     * @en Error message
     * @example 'Giao dịch thành công'
     */
    message: zod_1.z.string().default('').optional(),
}).strict();
