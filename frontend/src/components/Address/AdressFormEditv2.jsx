...
const AddressFormEditv2 = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addressAPI.updateAddressInDB(
        addressToEdit._id,
        formDataWithDefault
      );
        ...
        <div className="modal-box bg-white scrollbar-thin scrollbar-webkit">
          <div className="modal-action flex flex-col justify-center mt-0">
            <form className="" method="dialog" onSubmit={handleSubmit}>
              ...
              <div className="form-control mt-3">
                <label
                  className={`cursor-pointer flex items-center text-black relative ${
                    isDefaultAddress ? "opacity-50 cursor-not-allowed" : ""
                  }`}
                >
                  <input
                    type="checkbox"
...
export default AddressFormEditv2;
